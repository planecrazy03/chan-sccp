...
static boolean_t sccp_wrapper_asterisk113_createRtpInstance(constDevicePtr d, constChannelPtr c, sccp_rtp_t *rtp)
{
...
static boolean_t sccp_wrapper_asterisk113_blind_transfer(sccp_channel_t * transferee, const char *extension, const char *context)
{
	int res = FALSE;
...
const PbxInterface iPbx = {
	...
	rtp_codec:			NULL,
	rtp_create_instance:		sccp_wrapper_asterisk113_createRtpInstance,
...
//	endpoint_shutdown:		sccp_wrapper_asterisk113_endpoint_shutdown,
	...
	removeTimingFD:			sccp_wrapper_asterisk113_removeTimingFD,
